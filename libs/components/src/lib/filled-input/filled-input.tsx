...
export interface FilledInputProps
   ...
   labelProps?: React.DetailedHTMLProps<
      ...
      HTMLLabelElement
   >;
   errorMsjProps?: React.DetailedHTMLProps<
...
export const FilledInput: FC<FilledInputProps> = ({
   errorText = '-',
   labelProps,
   labelText,
   errorMsjProps,
   ...
   const inputClasses: string = `${styles['input']} ${
   ...
   return (
      ...
      >
         ...
         <p className={`${styles['error-msj']} ${!error ? styles['invisible'] : ''}`}>
            {errorText}
         </p>
